...
def fitness_function_kmeans(**kwargs) -> float:
    try:
        ...
        kmeans = KMeans(n_clusters=cluster_size, random_state=None, init=np.array(kwargs['chromosome']), n_init=1)
...
if __name__ == '__main__':
    ...
    ga = GeneticAlgorithm(population_size=50, max_generation=100, gene_type='array_range_float',
